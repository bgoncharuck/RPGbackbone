...
abstract class Artifact(val _code: Code, val _effects: List<rpgbackbone.Ench.Template>): Template {
...
abstract class Guardian(val _code: Code, val _effects: List<rpgbackbone.Ench.Template>): Template {
  override val code: Code= _code
...
abstract class MagicHit(val _code: Code, val _effects: List<rpgbackbone.Ench.Template>): Template {
  override val code: Code= _code
  override val target: rpgbackbone.Target = rpgbackbone.Target.SELECTED
...
abstract class WeaponHit(val _code: Code, val _effects: List<rpgbackbone.Ench.Template>): Template {
  override val code: Code= _code
